      ...
      <section className="card p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="section-title">Review seller submissions and marketplace quality</h1>
            <p className="mt-2 max-w-2xl text-sm text-slate-500 dark:text-slate-400">
              Approve or reject seller products, leave moderation notes, and keep featured inventory aligned with the marketplace experience.
            </p>
          </div>
              ...
              filteredProducts.map((product) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    setReviewNotes(product.approvalNotes || "");
                    setFeatureToggle(Boolean(product.isFeatured));
                  }}
                >
